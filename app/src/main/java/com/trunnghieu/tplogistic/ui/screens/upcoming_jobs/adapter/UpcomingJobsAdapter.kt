package com.trunnghieu.tplogistic.ui.screens.upcoming_jobs.adapter
...
import com.trunnghieu.tplogistic.databinding.ItemUpcomingJobBinding
    ...
    override fun onBindViewHolder(holder: BaseBindingViewHolder<Job>, position: Int) {
        ...
        if (!jobSelectionAllowed) {
            ...
            binding.run {
                ...
                tvPickupLocation.text = item.getPickUpLocation()
                tvDeliveryLocation.text = item.getUnloadLocation()
                tvCustomerName.text = item.pickUpContactName
                tvProductName.text = item.getProductNames()
