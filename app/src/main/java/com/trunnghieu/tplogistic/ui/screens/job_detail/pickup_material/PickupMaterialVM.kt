...
//        needSubmitArriveAtPickupLocation = false
        ...
        isTripBased = latestJob!!.isTonBased
...
//        )
    ...
    private fun checkExtraCasesAtPickup(): Boolean {
        if (eSignRequired) {
            showLoading(true)
            driverJobRepo.updateJobStatus(LocalJob.get().getLatestJob()?.id ?: "", updateJobStatusDto = UpdateJobStatusDto(
                jobStatus = ApiConst.JobStatus.DRIVER_PICKUP_DONE.statusCode
